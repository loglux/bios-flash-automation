...
REM Step beyond HP-ProBook-BiosCheck-v4.bat (kept as-is, untouched).
REM Same as v4 (boot settings check/fix, then version -> A.bat, CA key
REM -> B.bat), but right before launching C.bat, resets Fast Boot,
REM Boot Order, and Startup Delay back to factory defaults - same
REM logic as HP-ProBook-ResetBootSettings.bat - since B.bat has just
REM run by that point, the BIOS password is set.
...
REM ============================================
REM  STEP 1: boot settings, before anything else - no BIOS password
REM  exists yet at this point (B.bat hasn't run), so no /cpwdfile.
REM ============================================
...
REM ============================================
REM  STEP 4: A and B confirmed - reset boot settings to factory
...
REM ============================================
REM  Boot Order (ordered list) - USB first, before A.bat
REM ============================================

...
REM
REM How to use: same as HP-ProBook-SetBootNext.bat - run this, then
REM reboot - "shutdown /r" if testing from full Windows, "wpeutil
REM reboot" if testing from WinPE (confirmed "shutdown" doesn't work
REM there). See experimental/BCDEdit-BootSequence-Notes.md for
REM background.
